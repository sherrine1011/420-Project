...
This project uses an [open source dataset](https://dasl.datadescription.com/datafile/housing-prices-ge19/?_sfm_methods=Multiple+Regression&_sfm_cases=1104+59943) from [DASL Data and Story Library](http://lib.stat.cmu.edu/DASL/), which include 16 explanatory features for predicting prices and 1,735 entries of housing sales in Ney York, USA. 

For our project, we shall be considering 8 below features as predictors for model with `Price` value of the house as response.
...
## Our Goal 
Our goal is to use different combination of predictor and apply regression models () to predict the house prices in King County, USA. 
`TODO: Have to fill more info`
